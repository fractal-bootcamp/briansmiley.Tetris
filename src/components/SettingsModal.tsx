...
export default function SettingsModal({ closeModal }: SettingsModalProps) {
  ...
  return (
    <div className="text-default border-inset relative flex w-[50%] flex-col items-center justify-center gap-1 bg-slate-900 p-2">
      <button
        onClick={closeModal}
      ...
      <div className="mb-2 font-bold underline">Settings</div>
